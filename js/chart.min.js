        ...
        name: "Doughnut", defaults: e, initialize: function (a) {
            ...
            d.each(this.segments, function (d, e) {
                d.transition({
                    ...
                    outerRadius: this.outerRadius,
                    innerRadius: this.outerRadius / 100 * this.options.percentageInnerCutout
                }, b), d.endAngle = d.startAngle + d.circumference, d.draw(), 0 === e && (d.startAngle = 1.5 * Math.PI), e < this.segments.length - 1 && (this.segments[e + 1].startAngle = d.endAngle), this.options.scaleShowLabels && d.showLabel && (c || (c = {}), this.drawLabel(d, a, c))
            }, this)
        }
